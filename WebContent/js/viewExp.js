				...
				//		console.log(result);
							...
							for (j in result)
						{
							...
							data += "<tr><td>"+			
								    ...
								    '<a id="more"  style="color:red	;" href="http://localhost:8090/PlacementPortalFrontEnd/experience.html?id='+result[j]["id"]+'"><b>Read More</b></a>'+
...
function getter(result)
{
						...
						for (k in result)
						{
							...
							data2 += "<tr><td>"+			
								   ...
								   '<a id="more"  style="color:red	;" href="http://localhost:8090/PlacementPortalFrontEnd/experience.html?id='+result[k]["id"]+'"><b>Read More</b></a>'+
								   '</li></ul></div></div></div></td></tr>';
